...
import { editUserData, userDetail } from "../../redux/features/userslice";
      ...
      <div className="flex ">
        ...
        {edit ? (
          <div>
            ...
            <div className="mt-5">
              <p className="px-6 text-slate-500 font-serif ">DATE OF BIRTH</p>
              <div className="flex items-center mx-6 mt-2">
        ...
        {/* <div>
          <p className="px-6 text-slate-500 font-serif pt-[2rem]">USER NAME</p>
          <div className="h-7 w-40 bg-white border mx-6 mt-2">
            <div className="flex">
              <FaRegUser className="mx-2 mt-1" size={14} />
