  ...
  return (
    <div className="flex ">
      ...
      <div className="bg-gray-50 w-1/2">
        {product ? (
          <>
            <h2 className="mx-1 text-3xl font-serif mt-10">{product.name}</h2>
              ...
              <div className="mx-1 mt-3">
                ...
                <ul className="mt-4 mx-10">
                  {product.description.split("\n").map((item, index) => (
                    <li key={index} className="text-sm font-serif list-disc">
                      {item}
                    </li>
                  ))}
                </ul>
            ...
            <button  className="bg-blue-400 rounded-lg mt-10 w-36 h-12 text-lg font-serif font-bold text-white">Add to Cart</button>
          </>
        ) : (
          <p>Loading...</p>
        )}
