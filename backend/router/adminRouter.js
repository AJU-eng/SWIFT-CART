...
const {getUser,userBlock, userUnblock, userDelete, CategoryAdd, getCategories, AddProducts, getCate, BlockCategories, UnblockCategories, adminLogout, adminLoggedIn, getCategoriesAdd, getTotalCustomer, getPendingTotal} = require('../controller/adminController')
...
const { getAdminOrders, updateOrderStatus } = require('../controller/OrderController')
...
adminRouter.get("/getTotalUser",getTotalCustomer)
adminRouter.get("/getPending",getPendingTotal)
